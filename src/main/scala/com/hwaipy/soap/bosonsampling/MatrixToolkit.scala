...
object MatrixToolkit extends App {
  ...
  //      }
  //      val m2 = ComplexMatrix.valueOf(Range(0, matrix.getNumberOfRows).filter(i => i != deleteIndex).map(i => matrix.getRow(i)).asJava)
  //      isRow match {
  //        case true => m2
  ...
  //      val subM = ComplexMatrix.valueOf(columns.asJava).transpose
  ...
  //      val permM = ComplexMatrix.valueOf(rows.asJava)
  ...
  //      ComplexMatrix.valueOf(rows.asJava)
  //    }
  //  }
  //
  ...
  //      ComplexVector.valueOf(normaledItems.asJava)
  //    }
  //
  //    def toList = {
